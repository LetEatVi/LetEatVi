				...
				<div class="buyProductText">
					...
					<div class="row detail-box">
						...
						<div class="col detail-btn" style="max-width: 25%;">
							<div class="row">
								...
								<button type="button" class="btn btn-dark btn-lg"
									id="detail-btn"
									style="width: 90%; border: 1px solid #D3D3D3; border-radius: 10px; margin: auto; font-family: 'IBMPlexSansKR-Regular'; margin-top: 25px; letter-spacing: 3px; background-color: rgba(0, 0, 0, 0); color: black; margin-bottom: 29px;">리뷰
									작성하기</button>
							</div>
						</div>
					</div>
					...
					<div class="row about-paytext"
						...
						<div class="col">
							...
							<div class="row inner-row"
								style="padding-top: 15px; padding-left: 10px;">카카오페이</div>
						</div>
						<div class="col"
					...
					<div class="row about-paytext"
						...
						<div class="col" style="background-color: #F2F2F2; max-width: 45%">
							<div class="row" style="padding-top: 15px;">
								<div class="col col-th">카카오페이</div>
								<div class="col col-td">${p.totalPrice}</div>
							</div>
							<div class="row" style="padding-top: 15px;">
