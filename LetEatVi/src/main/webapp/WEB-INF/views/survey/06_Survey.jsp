...
#survey-content {
	background-image:
		url(/leteatvi/resources/images/surveyImg/background6.jpg);
}
								...
								<form id="frm6" action="">
									<div id="survey-question">
										<section id="question-section">
											...
											<br>
											<ul id="survey-answer">
												<li><label for="heal03_a"> <input
														type="checkbox" name="heal03" id="heal03_a"> 평소 뼈가
														약한 느낌이 있고 부러져 본 경험이 있어요.
												</label> <label for="heal03_b"> <input type="checkbox"
														name="heal03" id="heal03_b"> 유제품생〮선채〮소과 같은 칼슘 식품의
														섭취가 부족해요.
												</label> <label for="heal03_c"> <input type="checkbox"
														name="heal03" id="heal03_c"> 운동을 즐기고, 활동하는 것을
														좋아해요.
												</label> <label for="heal03_d"> <input type="checkbox"
														name="heal03" id="heal03_d"> 햇볕을 쬘 시간이 부족하고, 뼈관〮절
														개선이 필요해요!
												</label></li>
											</ul>
										</section>
