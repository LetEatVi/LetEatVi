...
#survey-content {
	background-image:
		url(/leteatvi/resources/images/surveyImg/background7.jpg);
}
								...
								<form id="frm7" action="">
									<div id="survey-question">
										<section id="question-section">
											...
											<br>
											<ul id="survey-answer">
												<li><label for="heal04_a"> <input
														type="checkbox" name="heal04" id="heal04_a"> 스마트폰,
														컴퓨터를 자주 사용해요.
												</label> <label for="heal04_b"> <input type="checkbox"
														name="heal04" id="heal04_b"> 눈이 건조하고, 뻑뻑해요.
												</label> <label for="heal04_c"> <input type="checkbox"
														name="heal04" id="heal04_c"> 가끔 침침하고 흐릿해서 답답함을
														느껴요.
												</label> <label for="heal04_d"> <input type="checkbox"
														name="heal04" id="heal04_d"> 눈의 피로감 해소가 필요해요!
												</label></li>
											</ul>
										</section>
									</div>
