								...
								<form id="frmFirst" action="/leteatvi/survey/survey2.do">
									<div id="survey-question">
										<section id="question-section">
											...
											<ul id="survey-answer">
												<li>
													<div id="input-wrap">
														<input id="content-full" type="text"
															placeholder="이름 또는 닉네임" maxlength="10"
															value="${gst.userName}" name="userName" required>
													</div>
												</li>
											</ul>
										</section>
									...
									<div id="question-btn">
										<button type="button" id="prev-btn"
											onclick="location.href='/leteatvi/survey/survey.do';">이전</button>
