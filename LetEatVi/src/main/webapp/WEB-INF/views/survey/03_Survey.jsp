...
#survey-content {
	background-image:
		url(/leteatvi/resources/images/surveyImg/background3.jpg);
								...
								<form id="frmThird" action="">
									<div id="survey-question">
										<section id="question-section">
											...
											<ul id="survey-answer-interest">
												<li><label for="interest_heal01"> <input
														type="checkbox" name="interest" id="interest_heal01">
														<img
														src="${pageContext.request.contextPath}/resources/images/surveyImg/heart.png"
														alt="피로/기운" id="interest1" onclick="changeColor(this)";>
														<div>피로 / 기운</div>
												</label></li>
												<li><label for="interest_heal02"> <input
														type="checkbox" name="interest" id="interest_heal02"
														value="heal02"> <img
														src="${pageContext.request.contextPath}/resources/images/surveyImg/bowel.png"
														alt="장/간" id="interest2" onclick="changeColor(this)">
														<div>장 / 간</div>
												</label></li>
												<li><label for="interest_heal03"> <input
														type="checkbox" name="interest" id="interest_heal03"
														value="heal03"> <img
														src="${pageContext.request.contextPath}/resources/images/surveyImg/bone.png"
														alt="관절/뼈" id="interest3" onclick="changeColor(this)">
														<div>관절 / 뼈</div>
												</label></li>
												<li><label for="interest_heal04"> <input
														type="checkbox" name="interest" id="interest_heal04"
														value="heal04"> <img
														src="${pageContext.request.contextPath}/resources/images/surveyImg/eye.png"
														alt="눈 건강" id="interest4" onclick="changeColor(this)">
														<div>눈 건강</div>
												</label></li>
												<li><label for="interest_heal05"> <input
														type="checkbox" name="interest" id="interest_heal05"
														value="heal05"> <img
														src="${pageContext.request.contextPath}/resources/images/surveyImg/skin.png"
														alt="피부/모발" id="interest5" onclick="changeColor(this)">
														<div>피부 / 모발</div>
												</label></li>
												<li><label for="interest_heal06"> <input
														type="checkbox" name="interest" id="interest_heal06"
														value="heal06"> <img
														src="${pageContext.request.contextPath}/resources/images/surveyImg/metabolism.png"
														alt="면연력/노화" id="interest6" onclick="changeColor(this)">
														<div>면역력 / 노화</div>
												</label></li>
											</ul>
										</section>
									...
									<div id="question-btn">
										<button type="button" id="prev-btn"
											onclick="location.href='/leteatvi/survey/survey2.do';">이전</button>
