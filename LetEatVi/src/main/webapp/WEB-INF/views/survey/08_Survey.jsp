...
#survey-content {
	background-image:
		url(/leteatvi/resources/images/surveyImg/background8.jpg);
}
								...
								<form id="frm8" action="">
									<div id="survey-question">
										<section id="question-section">
											...
											<br>
											<ul id="survey-answer">
												<li><label for="heal05_a"> <input
														type="checkbox" name="heal05" id="heal05_a"> 피부가
														건조하거나 예민한 편 같아요.
												</label> <label for="heal05_b"> <input type="checkbox"
														name="heal05" id="heal05_b"> 여드름과 뾰루지 같은 염증이 자주
														생겨요.
												</label> <label for="heal05_c"> <input type="checkbox"
														name="heal05" id="heal05_c"> 탈모, 새치, 머리카락 등 모발 상태가
														신경쓰여요.
												</label> <label for="heal05_d"> <input type="checkbox"
														name="heal05" id="heal05_d"> 피부에 관심이 많고 건강한 피부 개선이
														필요해요!
												</label></li>
											</ul>
										</section>
