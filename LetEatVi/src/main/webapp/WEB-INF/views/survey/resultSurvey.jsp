		...
		<div class="result-page">
			<div class="result-wrap">
				<div class="result-head">
					<h3>
						<span id="namePlace"></span> 님의 건강설문 결과표
					</h3>
					<dl>
						<dt>성별</dt>
						<dd id="gender"></dd>
						...
						<dd id="age-bend"></dd>
						<dt>
							BMI <span> <img class="bmi-info"
								src="${pageContext.request.contextPath}/resources/images/surveyImg/info.png"
								alt="info" />
							</span>
						</dt>
						<dd id="bmi-value"></dd>
					...
					<div class="bmi-content">
						...
						<p class="bmi-concept">
							비만도를 나타내는 지수로 체중과 키의 관계를 이용하여 간접적으로 계산하여 평가를 합니다. <br> (몸무게를
							키의 제곱으로 나눈 값) <br>
							<br>- 저체중: 18.5 미만 <br>- 정상 체중: 18.5 ~ 22.9 <br>-
							과체중: 23.0 ~ 24.9 <br>- 비만: 25.0 ~ 29.9 <br>- 고도비만: 30.0
							이상
						</p>
					</div>
					<div class="advice-wrap">
						<img
							src="${pageContext.request.contextPath}/resources/images/surveyImg/healthy.png"
							alt="">
						<h4>함께 노력 해보아요!</h4>
				...
				<nav class="recommend-wrap">
					...
					<ul class="recommend-item-wrap">
						<li class="recommend-item">
							<div class="item-img">
								<img
									src="${pageContext.request.contextPath}/resources/images/surveyImg/male.png"
									alt="">
							</div>
							<div class="item-name">
								<p>비타민 B</p>
				...
				<div class="result-guide">
					<div class="guide-wrap">
						<div class="custom-guide">
							<h3>
								Let's Eat Vitamin! 10 연령대에게 <b>[종합비타민]</b> 추천드립니다.
							</h3>
							<ul>
							...
							<p>
								균형 잡힌 영양을 통한 건강한 성장이 가장 중요합니다 <br> 추천 음식 : 갑각류 달걀, 육류
							</p>
							<span> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/lobster.png"
								alt=""> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/egg.png"
								alt=""> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/meat.png"
								alt="">
							</span>
						</div>
						<div class="custom-guide">
							<h3>
								Let's Eat Vitamin! 20연령대에게 <b>[비타민B, 비타민D]</b> 추천드립니다.
							</h3>
							<ul>
								<li># 청년기에 해당됩니다.</li>
							...
							<p>
								학업, 취업 또는 직장 생활에 스트레스가 많고, 실내에 있는 시간이 많죠. <br> 추천 음식 : 곡물류,
								달걀, 과일(특히 키위, 토마토, 오렌지)
							</p>
							<span> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/grains.png"
								alt=""> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/egg.png"
								alt=""> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/tomato.png"
								alt="">
							</span>
						</div>
						<div class="custom-guide">
							...
							<h3>
								Let's Eat Vitamin! 30 연령대에게 <b>[비타민B, 비타민D]</b> 추천드립니다.
							</h3>
							<ul>
								<li># 장년기에 해당됩니다.</li>
							...
							<p>
								공부 또는 직장 생활에 스트레스가 많고, 실내에 있는 시간이 많죠. <br> 추천 음식 : 곡물류, 달걀,
								과일(특히 키위, 토마토, 오렌지)
							</p>
							<span> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/grains.png"
						...
						<div class="custom-guide">
							...
							<h3>
								Let's Eat Vitamin! 40 연령대에게 <b>[항산화, 미네랄]</b> 추천드립니다.
							</h3>
							<ul>
								<li># 장년기에 해당됩니다.</li>
								<li># 체력과 운동능력이 쇠약해지는 만큼, 함께 노력해요!</li>
							...
							<p>
								노화가 진행되는 시기입니다. 지금 부터 예방하고, 개선하면 좋을 것 같아요. <br> 추천 음식 : 콩,
								색이 진한 채소 또는 과일
							</p>
							<span> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/beans.png"
								alt=""> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/vegetable.png"
								alt=""> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/fruits.png"
								alt="">
							</span>
						</div>
						<div class="custom-guide">
							...
							<h3>
								Let's Eat Vitamin! 50 연령대이상 에게 <b>[오메가3]</b> 추천드립니다.
							</h3>
							<ul>
							...
							<p>
								노화가 진행되고 있습니다. 영양제가 많이 필요한 시기입니다. <br> 추천 음식 : 콩, 색이 진한 채소
								또는 과일
							</p>
							<span> <img
								src="${pageContext.request.contextPath}/resources/images/surveyImg/beans.png"
